...
#		mvn:<groupId>/<artifactId>/<version>/<type>
#
original.distribution.artifact=mvn:org.jboss.fuse/jboss-fuse-minimal/6.1.0.redhat-379/zip
...
#	 
distribution.output.final.name=fuse-esb-6.1.0.redhat-379-custom
